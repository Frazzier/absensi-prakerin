            ...
            <div class="col-12 col-md-8">
                <div class="row">
                    ...
                    <div class="form-group col-12 col-md-6">
                        ...
                        <input type="text" class="form-control" name="name" id="name" value="{{old('name') ?? $student->user->name}}">
                    </div>
                    <div class="form-group col-12 col-md-6">
                    ...
                    <div class="form-group col-12">
                        ...
                        <input type="email" class="form-control" name="email" id="email" value="{{old('email') ?? $student->user->email}}">
                    </div>
                    <div class="col-12 mb-2" style="border-left: 5px solid #f0ad4e; border-radius: 5px;"><h5>Reset Password</h5></div>
                    <div class="form-group col-12 col-md-6">
                    ...
                    <div class="col-12 mb-2">
                        ...
                        <select class="form-control" name="company_id">
                            ...
                            <option value="{{$company->id}}" @if($student->company_id == $company->id) selected @endif>{{$company->name}}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="col-12 mb-2">
                        ...
                        <select class="form-control" name="mentor_id">
                            ...
                            <option value="{{$mentor->id}}" @if($student->mentor_id == $mentor->id) selected @endif>{{$mentor->name}}</option>
                            @endforeach
                        </select>
                    </div>
            </div>
